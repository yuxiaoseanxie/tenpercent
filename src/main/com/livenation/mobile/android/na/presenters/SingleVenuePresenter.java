...
public class SingleVenuePresenter extends
	...
	public void initialize(Context context, Bundle args, SingleVenueView view) {
		SingleVenueState state = new SingleVenueState(SingleVenuePresenter.this, view);
		String venueIdRaw = args.getString(PARAMETER_EVENT_ID);
		long eventId = Event.getNumericEventId(venueIdRaw);
	...
	static class SingleVenueState extends BaseState<SingleVenueView> implements
		...
		public SingleVenueState(StateListener<SingleVenueState> listener,
				SingleVenueView view) {
			super(listener, view);
			this.view = view;
		}

		public void retrieveEvent(long venueId) {
