...
public class MusicSyncHelper implements ApiServiceBinder {
    ...
    private BasicApiCallback<Void> callback;
    ...
    public synchronized void syncMusic(Context ctx, BasicApiCallback<Void> responseCallback) {
    ...
    public void onApiServiceAttached(LiveNationApiService apiService) {
        apiService.sendLibraryAffinities(new LibraryAffinitiesParameters().setLibraryDump(musicLibrary), new BasicApiCallback<Void>() {
            @Override
